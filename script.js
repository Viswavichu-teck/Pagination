...
function paginate(pageNumber) {
  ...
  let endIndex = Math.min(startIndex + 10, students.length);
  ...
  let existingThead = tabl.querySelector("thead");
  if (existingThead) {
      tabl.replaceChild(thead, existingThead);
  } else {
      tabl.insertBefore(thead, tbody);
  }
}
